...
public class ClojureParser {
	...
	private Tree<Integer> P(Integer... values) throws ParseException {
		switch (lex.curToken().name()) {
			case "$" -> {
				Tree<Integer> t = new Tree<Integer>(new NonTerminal("P"));
				return t;
			}
			case "(" -> {
				Tree<Integer> SF1 = SF();
				Tree<Integer> P2 = P();
				Tree<Integer> t = new Tree<Integer>(new NonTerminal("P"), SF1, P2);
				return t;
			}
	...
	private Tree<Integer> SF(Integer... values) throws ParseException {
		switch (lex.curToken().name()) {
			case "(" -> {
				Tree<Integer> F1 = F();
				Tree<Integer> t = new Tree<Integer>(new NonTerminal("SF"), F1);
				return t;
			}
			default -> throw new IllegalStateException("Unexpected value: " + lex.curToken());
		}
	...
	private Tree<Integer> F(Integer... values) throws ParseException {
		switch (lex.curToken().name()) {
			case "(" -> {
				...
				lex.nextToken();
				Tree<Integer> t = new Tree<Integer>(new NonTerminal("F"), token1, FB2, token3);
				return t;
			}
			default -> throw new IllegalStateException("Unexpected value: " + lex.curToken());
		}
	...
	private Tree<Integer> FB(Integer... values) throws ParseException {
		switch (lex.curToken().name()) {
			case "DEFN" -> {
				...
				Tree<Integer> t = new Tree<Integer>(new NonTerminal("FB"), DEFN1);
				return t;
			}
			case "NS" -> {
				Tree<Integer> NS1 = NS();
				Tree<Integer> t = new Tree<Integer>(new NonTerminal("FB"), NS1);
				return t;
			}
			case "id" -> {
				Tree<Integer> GF1 = GF();
				Tree<Integer> t = new Tree<Integer>(new NonTerminal("FB"), GF1);
				return t;
			}
			case "LET" -> {
				Tree<Integer> LET1 = LET();
				Tree<Integer> t = new Tree<Integer>(new NonTerminal("FB"), LET1);
				return t;
			}
			case "+", "*", "/", "-" -> {
				Tree<Integer> AF1 = AF();
				Tree<Integer> t = new Tree<Integer>(new NonTerminal("FB"), AF1);
				return t;
			}
			default -> throw new IllegalStateException("Unexpected value: " + lex.curToken());
		}
	...
	private Tree<Integer> NS(Integer... values) throws ParseException {
		switch (lex.curToken().name()) {
			case "NS" -> {
				...
				lex.nextToken();
				Tree<Integer> t = new Tree<Integer>(new NonTerminal("NS"), token1, token2);
				return t;
			}
			default -> throw new IllegalStateException("Unexpected value: " + lex.curToken());
		}
	...
	private Tree<Integer> DEFN(Integer... values) throws ParseException {
		switch (lex.curToken().name()) {
			case "DEFN" -> {
				...
				Tree<Integer> t = new Tree<Integer>(new NonTerminal("DEFN"), token1, token2, token3, AI4, token5, FORM6);
				return t;
			}
			default -> throw new IllegalStateException("Unexpected value: " + lex.curToken());
		}
	...
	private Tree<Integer> LET(Integer... values) throws ParseException {
		switch (lex.curToken().name()) {
			case "LET" -> {
				...
				lex.nextToken();
				Tree<Integer> ES5 = ES();
				Tree<Integer> t = new Tree<Integer>(new NonTerminal("LET"), token1, token2, BS3, token4, ES5);
				return t;
			}
			default -> throw new IllegalStateException("Unexpected value: " + lex.curToken());
		}
	...
	private Tree<Integer> BS(Integer... values) throws ParseException {
		switch (lex.curToken().name()) {
			case "]" -> {
				Tree<Integer> t = new Tree<Integer>(new NonTerminal("BS"));
				return t;
			}
			case "id" -> {
				Tree<Integer> B1 = B();
				Tree<Integer> BS2 = BS();
				Tree<Integer> t = new Tree<Integer>(new NonTerminal("BS"), B1, BS2);
				return t;
			}
			default -> throw new IllegalStateException("Unexpected value: " + lex.curToken());
		}
	...
	private Tree<Integer> B(Integer... values) throws ParseException {
		switch (lex.curToken().name()) {
			case "id" -> {
				...
				Tree<Integer> t = new Tree<Integer>(new NonTerminal("B"), token1, FORM2);
				return t;
			}
			default -> throw new IllegalStateException("Unexpected value: " + lex.curToken());
		}
	...
	private Tree<Integer> ES(Integer... values) throws ParseException {
		switch (lex.curToken().name()) {
			case "(" -> {
				Tree<Integer> F1 = F();
				Tree<Integer> ES2 = ES();
				Tree<Integer> t = new Tree<Integer>(new NonTerminal("ES"), F1, ES2);
				return t;
			}
			case ")" -> {
				Tree<Integer> t = new Tree<Integer>(new NonTerminal("ES"));
				return t;
			}
			default -> throw new IllegalStateException("Unexpected value: " + lex.curToken());
		}
	...
	private Tree<Integer> AF(Integer... values) throws ParseException {
		switch (lex.curToken().name()) {
			case "+", "*", "/", "-" -> {
				...
				Tree<Integer> t = new Tree<Integer>(new NonTerminal("AF"), OP1, FORMM2);
				return t;
			}
			default -> throw new IllegalStateException("Unexpected value: " + lex.curToken());
		}
	...
	private Tree<Integer> FORMM(Integer... values) throws ParseException {
		switch (lex.curToken().name()) {
			case "(", "id", "number", "string" -> {
				...
				Tree<Integer> FORMM2 = FORMM();
				Tree<Integer> t = new Tree<Integer>(new NonTerminal("FORMM"), FORM1, FORMM2);
				return t;
			}
			case ")" -> {
				Tree<Integer> t = new Tree<Integer>(new NonTerminal("FORMM"));
				return t;
			}
			default -> throw new IllegalStateException("Unexpected value: " + lex.curToken());
		}
	...
	private Tree<Integer> GF(Integer... values) throws ParseException {
		switch (lex.curToken().name()) {
			case "id" -> {
				...
				lex.nextToken();
				Tree<Integer> FORMM2 = FORMM();
				Tree<Integer> t = new Tree<Integer>(new NonTerminal("GF"), token1, FORMM2);
				return t;
			}
			default -> throw new IllegalStateException("Unexpected value: " + lex.curToken());
		}
	...
	private Tree<Integer> AI(Integer... values) throws ParseException {
		switch (lex.curToken().name()) {
			case "]" -> {
				Tree<Integer> t = new Tree<Integer>(new NonTerminal("AI"));
				return t;
			}
			case "id" -> {
				assert lex.curToken().name().equals("id");
				...
				lex.nextToken();
				Tree<Integer> AI2 = AI();
				Tree<Integer> t = new Tree<Integer>(new NonTerminal("AI"), token1, AI2);
				return t;
			}
			default -> throw new IllegalStateException("Unexpected value: " + lex.curToken());
		}
	...
	private Tree<Integer> FORM(Integer... values) throws ParseException {
		switch (lex.curToken().name()) {
			case "id", "number", "string" -> {
				...
				Tree<Integer> t = new Tree<Integer>(new NonTerminal("FORM"), ATOM1);
				return t;
			}
			case "(" -> {
				Tree<Integer> F1 = F();
				Tree<Integer> t = new Tree<Integer>(new NonTerminal("FORM"), F1);
				return t;
			}
			default -> throw new IllegalStateException("Unexpected value: " + lex.curToken());
		}
	...
	private Tree<Integer> ATOM(Integer... values) throws ParseException {
		switch (lex.curToken().name()) {
			case "number" -> {
				...
				Tree<Integer> token1 = new Tree(lex.curToken());
				lex.nextToken();
				Tree<Integer> t = new Tree<Integer>(new NonTerminal("ATOM"), token1);
				return t;
			}
			case "id" -> {
				assert lex.curToken().name().equals("id");
	...
	private Tree<Integer> OP(Integer... values) throws ParseException {
		switch (lex.curToken().name()) {
			case "/" -> {
				...
				Tree<Integer> token1 = new Tree(lex.curToken());
				lex.nextToken();
				Tree<Integer> t = new Tree<Integer>(new NonTerminal("OP"), token1);
				return t;
			}
			case "+" -> {
				assert lex.curToken().name().equals("+");
